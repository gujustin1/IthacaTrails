...
class Review(db.Model):
  ...
  comments = db.relationship('Comment', cascade='delete', back_populates='review') #association
...
class Comment(db.Model):
  ...
  review = db.relationship('Review', back_populates='comments') #association
...
class Trail(db.Model):
  ...
  activities = db.relationship('Activity', secondary=association_table, back_populates='trails') #association
...
class Activity(db.Model):
  ...
  id = db.Column(db.Integer, primary_key = True)
  name = db.Column(db.String, nullable = False)
  trails = db.relationship('Trail', secondary=association_table, back_populates='activities') #association
